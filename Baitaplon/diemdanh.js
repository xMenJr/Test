...
function add() {
    ...
    var dd = document.getElementById('diemdanh').value;
...
function Show() {
    ...
    for( var i=0; i<arrEmployee.length; i++) {
        ...
        cell7.innerHTML = objE.diemdanh
        cell8.innerHTML = "<button onclick='Edit(this)'>Sửa</button>";
    }
}
function Edit(el) {
    // console.log(el);
    ...
    var diemdanh = selectedRow.cells[6].innerText;
    ...
    document.getElementById("diemdanh").value = diemdanh;
...
function update() {
    ...
    arrEmployee[selectedIndex].diemdanh = document.getElementById("diemdanh").value;
...
function reSet() {
    ...
    document.getElementById("diemdanh").value =" ";
}
...
function err() {
    ...
    var dd = document.getElementById('diemdanh').value;
    if(dd == "") {
        document.getElementById('diemdanherr').innerHTML = "Bạn chưa nhập Điểm danh";
        return false;
    }
    else {
        document.getElementById('diemdanherr').innerHTML = "";
    }
    return result;
}